...
if(isset($_POST['btn']))
{
  $qry=mysql_query("select * from hr where email='$uname' && name='$pass'");
$num=mysql_num_rows($qry);
if($num==1)
{
header("location:hrhome.jsp");
...
<div class="wrapper col1">
  <div id="header">
    <div id="logo">
      <h1><a href="index.jsp">Human Resource </a></h1>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Management</p>
    </div>
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="login.jsp">HR Login</a></li>
