...
<div class="wrapper col3">
  <div id="container">
    ...
    <form id="form1" name="form1" method="post" action="">
      <p align="center" class="style23 style10"><strong>Advisor Details </strong></p>
...
%>
        <tr>
          <td height="31"><div align="center"><% out.print(rs0.getString("UserName"));%><?php echo $row['UserName'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("Age"));%><?php echo $row['Age'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("Gender"));%><?php echo $row['Gender'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("MobileNumber"));%><?php echo $row['MobileNumber'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("EmailId"));%><?php echo $row['EmailId'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("Education"));%><?php echo $row['Education'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("Experience"));%><?php echo $row['Experience'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("District"));%><?php echo $row['District'];?></div></td>
          <td><div align="center"><% out.print(rs0.getString("State"));%><?php echo $row['State'];?></div></td>
        </tr>
         <%
